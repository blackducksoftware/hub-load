...
export MULTI_SCAN_CONFIG="BINARY_SCAN_SMALL:40,BINARY_SCAN_MEDIUM:30,BINARY_SCAN_LARGE:7,BINARY_SCAN_XLARGE:3,SIGNATURE_SCAN_SMALL:3,SIGNATURE_SCAN_MEDIUM:2,SNIPPET_SCAN:2,CONTAINER_SCAN_SMALL:5,CONTAINER_SCAN_MEDIUM:4,CONTAINER_SCAN_LARGE:3,CONTAINER_SCAN_XLARGE:1"
